...
if ($data_token['session'] == session_id()) {
    ...
    if(!$user_group == "1"){
        ...
        ////#############
        $get_collections_plataform = "SELECT * FROM collections Where collection_active = '1' ";
                        ...
                        <div class="send_delights_int">
                            <div class="area_send_delights">
                                ...
                                <?php foreach ($result as $itemCollection):?>
                                    <div class="area_radio" style="margin-top: 20px;">
                                        <div class="area_radio_int" style="display: flex; margin: 0;float: left; text-align: left;">
                                            <input type="radio" class="radio">
                                            <div class="box_radio">
                                            <?php echo(isset($itemCollection['collection_image']) ? "<img width='56px' height='56px' src=".$itemCollection['collection_image'].">" : '');?>
                                            </div>
                                        </div>
                                    </div>
                                    <?php endforeach;?>
