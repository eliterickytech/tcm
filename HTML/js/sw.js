...
const OFFLINE_URL = 'off-line.html';


$(document).ready(function(){
  $(".setup_button").click(function (event) {
      installApp();
  });
});
...
function showAddToHomeScreen() {
  const modal = document.querySelector('.add-to-homescreen');
  modal.classList.add('show');
}

// Event listener for modal accept click
document.querySelector('.accept').addEventListener('click', () => {
  // Hide the modal
  document.querySelector('.add-to-homescreen').classList.remove('show');
  // Show the prompt
  deferredPrompt.prompt();
  // Wait for the user to respond to the prompt
...
// Event listener for modal dismiss click
