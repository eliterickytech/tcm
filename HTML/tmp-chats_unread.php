            ...
            <div class="container_home_int">
                <div class="area_home">
                    ...
                    <form action="#" method="POST">
                        <div class="area_form">
                            <input type="text" name="search" class="search" placeholder="Search chats">
                    ...
                    <div class="area_chats_all">
                        <div class="area_texts_chats">
                            ...
                            <div class="all_chats_unread">
                                <a href="#">
                                    <h2>All chats</h2>
                                    <div class="border_unread_c"></div>
                                </a>
                            </div>

                            <div class="chats_unread_u">
                                <a href="#">
                                    <h2>Unread</h2>
                    ...
                    <div class="menu_footer">
                        <div class="menu_footer_int">
                            ...
                            <div class="area_menu_footer">
                                ...
                                <a href="#">
                                    <div class="menu_f">
                                        <img width="27px" height="28px" src="img/Icon_community_In.png" alt="">
                                        <h2>Community</h2>
                                    </div>
                                </a>
                            </div>
