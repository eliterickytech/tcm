...
<html>
  ...
  <body onload="onLoad()" class="access">
    <div class="add-collection-2-operador-">
      ...
      <div class="piece-title">Single part*</div>
      <div class="piece-description">Collection description*</div>
      <img
      ...
      <div class="add-collection1">Add collection</div>
      <!-- START MINIATURE -->
      ...
      <form action="#" method="POST">
        ...
        <!-- FINAL MINIATURE -->      
      <!-- START SINGLE PART -->
        <img class="add-collection-2-operador-child1" id="collection_single_part" alt="" src="<?php echo(isset($singlePart) ? $singlePart : './img/file-minier.png');?>" />
        <textarea class="add-collection-2-operador-child4" name="single_part_collection_piece_description" id="single_part_collection_piece_description" cols="30" rows="10" placeholder="Collection description"></textarea>
      <!-- FINAL SINGLE PART -->
      ...
      <div class="add-collection-2-operador-child12">
      ...
      <form action="#" method="POST">
        <input type="submit" name="save-single-image-collection" id="save-single-image-collection" class="save-configurations" value="SAVE CONFIGURATIONS">
