...
{
    public class ManagerProfile : Controller
    {
        ...
        public ManagerProfile(IUserServices userServices, IChatServices chatServices, IConnectionServices connectionServices, ICollectionServices collectionServices)
        {
        ...
        public IActionResult Adm(int connectionUserId)
        {
